...
class Action extends AuthAction {
	function prepare() {
		...
		$this->_uploader = new Uploader(
			...
			$siteroot . '/publisher/'.$this->upload_publisher_id.'/images/book',
			$siteroot . '/publisher/'.$this->upload_publisher_id
		);
	...
	function execute() {
		...
		//グレートサイズがあるかどうかを確認する
		$result = $db->statement('admin/admin/import_images/sql/publisher.sql');
