...
<?php if(isset($this->config['uploadMaxsize'])):?>
<div style="position: absolute; right: 15px; bottom: 35px;">アップロードファイルの容量制限 : <?php echo $this->config['uploadMaxsize'] ?></div>
<?php endif;?>
<div style="position: absolute; right: 5px; bottom: 3px;">有効な拡張子 : <?php echo $this->config['allowedExts'] ?></div>
