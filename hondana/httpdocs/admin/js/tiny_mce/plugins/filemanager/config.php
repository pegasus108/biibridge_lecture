<?php
	...
	$extensionsList = "gif,jpg,jpeg,png,pdf,doc,docx,xls,xlsx,txt,zip,csv";
	// General options
	$mcFileManagerConfig['general.theme'] = "fm";
	$mcFileManagerConfig['general.user_friendly_paths'] = true;
	$mcFileManagerConfig['general.tools'] = "createdir,refresh,upload,edit,rename,cut,copy,paste,delete,selectall,unselectall,view,insert";
	$mcFileManagerConfig['general.disabled_tools'] = "";
	$mcFileManagerConfig['general.error_log'] = "";
	$mcFileManagerConfig['general.language'] = "ja"; // en, sv
	...
	$mcFileManagerConfig['filesystem.extensions'] = $extensionsList;
	...
	$mcFileManagerConfig['upload.extensions'] = $extensionsList;
	$mcFileManagerConfig['upload.multiple_upload'] = false;
	$mcFileManagerConfig['upload.use_flash'] = false;
	$mcFileManagerConfig['upload.allow_export'] = "maxsize,use_flash,multiple_upload,chunk_size,overwrite,extensions";
	...
	$mcFileManagerConfig['download.extensions'] = $extensionsList;
	...
	$mcFileManagerConfig['favorites.max'] = 0; // 20 is default.
	$mcFileManagerConfig['history.max'] = 0; // 20 is default.
