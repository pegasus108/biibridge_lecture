...
/**************************************************/
	...
	$_SESSION['imagemanager.filesystem.path'] = '../../../../../publisher/'.$_SESSION['id'].'/files';
	$_SESSION['imagemanager.filesystem.rootpath'] = '../../../../../publisher/'.$_SESSION['id'].'/files';
	$_SESSION['imagemanager.preview.wwwroot'] = '../../../../../publisher/'.$_SESSION['id'];
	$_SESSION['imagemanager.preview.urlprefix'] = $_SESSION['publisher_url'];

	$_SESSION['filemanager.filesystem.path'] = '../../../../../publisher/'.$_SESSION['id'].'/files';
	$_SESSION['filemanager.filesystem.rootpath'] = '../../../../../publisher/'.$_SESSION['id'].'/files';
	$_SESSION['filemanager.preview.wwwroot'] = '../../../../../publisher/'.$_SESSION['id'];
	$_SESSION['filemanager.preview.urlprefix'] = $_SESSION['publisher_url'];
