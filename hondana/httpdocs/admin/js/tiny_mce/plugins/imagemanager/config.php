<?php
	...
	$mcImageManagerConfig['general.plugins'] = "History"; // comma seperated
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,jpeg,png";
	...
	$mcImageManagerConfig['thumbnail.auto_generate'] = false; // only if above is set to true
	...
	$mcImageManagerConfig['upload.allow_export'] = "maxsize,use_flash,multiple_upload,chunk_size,overwrite,extensions";
	...
	$mcImageManagerConfig['favorites.max'] = 0; // 20 is default.
	$mcImageManagerConfig['history.max'] = 0; // 20 is default.
?>