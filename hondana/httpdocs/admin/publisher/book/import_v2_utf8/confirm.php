			...
			if(count($bookList)){
				...
				foreach($bookList as $key => $val){
					...
					foreach($bookList[$key] as $key2 => $val2){
						...
						// 61: 著者タイプ9 62: 著者名10 63: 著者カナ10 64: 著者タイプ10 65: 著者名11 66: 著者カナ11 67: 著者タイプ11
						// 68: 著者名12 69: 著者カナ12 70: 著者タイプ12 71: 著者名13 72: 著者カナ13 73: 著者タイプ13 74: 著者名14 75: 著者カナ14 76: 著者タイプ14
						// 77: 著者名15 78: 著者カナ15 79: 著者タイプ15
			...
			if(!($val[0]=='書名' && $val[1]=='書名カナ' && $val[2]=='巻次')){
				...
				if (!$val[29]){
					...
					foreach ($val[29] as $k => $v) {
						$cascade = explode('>',$v);
						if(count($cascade) > 3) {
							$this->error[] = ($key + 1) . '行目のジャンルの階層が3階層を超えています。' . $v;
						}
					}
				}
